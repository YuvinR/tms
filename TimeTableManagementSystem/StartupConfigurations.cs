        ...
        public void initiate()
        {
            ...
            try
            {
                ...
                if (!checkIfExist("Sessions"))
                {
                    ...
                    cmd.CommandText = "CREATE TABLE Sessions(Session_ID INTEGER Primary Key Autoincrement, Lecturers TEXT, Subject TEXT, Subject_Code TEXT, Tag TEXT, GroupID TEXT, Student_Count INTEGER,Duration  INTEGER, isDeAllocated INTEGER CHECK(isDeAllocated = 0 OR isDeAllocated = 1), NonOverLapCat varchar(100),ConsecutiveCat varchar(100),ParallelCat varchar(100), RoomID TEXT, MainGroupID TEXT);";
